        ...
        <SectionWrapper id="experience">
            <div className="flex justify-center items-center text-center mb-16">
                ...
                <motion.button
                    ...
                    className="hidden md:flex ml-4 p-3 bg-secondary dark:bg-dark-secondary rounded-full text-secondary-text dark:text-dark-highlight hover:text-accent dark:hover:text-dark-accent transition-colors"
                    aria-label="Toggle timeline layout"
            ...
            {/* Mobile layout */}
            <div className="md:hidden relative w-full max-w-lg mx-auto px-2">
                <div className="absolute left-4 top-0 h-full w-1 bg-gray-200 dark:bg-dark-secondary rounded-full"></div>
                {experience.map((item, index) => (
                    ...
                    >
                        <div className="flex-shrink-0 bg-accent dark:bg-dark-accent w-8 h-8 rounded-full flex items-center justify-center z-10 border-4 border-background dark:border-dark-background">
                            <FaBriefcase className="text-white dark:text-dark-background text-xs" />
                        </div>
